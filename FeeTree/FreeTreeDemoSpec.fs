...
[<Trait("given Client Income=39000; CriminalRecord=true ; YearsInJob=0 ; UsesCreditCard=false", "")>]
type ``Fee Tree Spec``() =

    [<Fact>]
    member this.``then should print NO in the console``() =
        ...
        let ret = FreeTreeEvaluator.testClientTree (john ,tree)
